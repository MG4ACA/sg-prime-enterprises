...
const productsData = [
  {
    ...
    description:
      '100% natural coconut coir fiber yarn woven to various sizes ideal for soil stabilization. Eco-friendly, biodegradable, and easy to install.',
    specifications: {
  ...
  },
  {
    ...
    category_slug: 'erosion-control',
    description:
      '100% natural knitted coir yarn tightly compressed to bales. Protects riverbanks and shorelines from high water currents.',
    specifications: {
      Dimensions: '2m x 50m',
  ...
  },
  {
    ...
    category_slug: 'erosion-control',
    description:
      'Cylindrical structures made of coir fiber encased in coir netting. Ideal for shoreline protection and sediment control.',
    specifications: {
  ...
  },
  {
    ...
    category_slug: 'erosion-control',
    description:
      'Middle Coir fiber with outside PP / Jute netting. Used as a blanket on slopes and hills to counteract soil erosion.',
    specifications: {
      Length: '10m to 50m',
      Width: '1m to 2m',
  ...
  },
  {
    ...
    description:
      'Coco peat and chip combination depending on plant type. Compressed blocks with integrated drainage holes. UV-treated plastic bag.',
    specifications: {
...
async function seedProducts() {
  ...
  try {
    ...
    for (const product of productsData) {
      ...
      if (!categoryId) {
        console.warn(
          `⚠️  Category "${product.category_slug}" not found for product "${product.name}"`,
        );
        continue;
      }
