...
const contactInfo = [
  {
    ...
    title: 'Visit Us',
    lines: ['Addarawtta, Kuleegoda', 'Ambalangoda, Sri Lanka'],
  ...
  },
  {
    icon: 'pi pi-phone',
    title: 'Call Us',
    lines: ['+61 449 946 069', 'Mon – Sat, 9:00 AM – 6:00 PM'],
    color: 'text-coir-600',
    bg: 'bg-coir-50',
  },
  {
    icon: 'pi pi-envelope',
    title: 'Email Us',
    lines: ['info@sgprimeenterprises.com'],
    color: 'text-bark-600',
    bg: 'bg-bark-50',
  },
  {
...
<template>
  <div>
    ...
    <section class="relative py-20 bg-bark-800 overflow-hidden">
      ...
      />
      <div class="relative max-w-7xl mx-auto px-4 text-center" v-reveal>
          ...
          >
            ...
            <Transition name="fade" mode="out-in">
              <div v-if="submitted" key="success" class="text-center py-12">
                ...
                <h2 class="font-display font-bold text-bark-800 text-2xl mb-3">
                  Message Received!
                </h2>
