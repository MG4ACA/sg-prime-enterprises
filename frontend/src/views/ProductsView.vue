...
// Stagger product cards whenever the list updates (load + filter changes)
...
<template>
  <div>
    ...
    <section class="relative py-20 overflow-hidden bg-bark-800">
      ...
      />
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" v-reveal>
        <span class="badge bg-earth-500/20 text-earth-400 mb-4">Product Catalogue</span>
        <h1 class="text-4xl md:text-5xl font-display font-bold text-white mb-5">
          Our Coir Products
        </h1>
        <p class="text-coir-300 text-lg max-w-2xl mx-auto">
          Sustainably manufactured coir products across three specialist categories — each designed
          to perform in harmony with nature.
        </p>
      </div>
    </section>
    ...
    <section class="bg-earth-500 py-14">
      <div class="max-w-4xl mx-auto px-4 text-center" v-reveal>
